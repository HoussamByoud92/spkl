...
export default function BookingPage() {
  ...
  const services = [
    { id: "nails", name: "Signature Nail Art", price: "250 DH", duration: "2 hours" },
    { id: "spa", name: "Luxurious Spa Treatments", price: "400 DH", duration: "2-3 hours" },
    { id: "hair", name: "Professional Hairdressing", price: "300 DH", duration: "2-3 hours" },
    { id: "lashes", name: "Lash Extensions", price: "350 DH", duration: "2 hours" },
    { id: "makeup", name: "Professional Makeup", price: "300 DH", duration: "2 hours" },
    { id: "aesthetic", name: "Aesthetic Services", price: "500 DH", duration: "1-2 hours" },
  ]
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Thank you for booking with Sparkle Beauty Empire. We've sent a confirmation email to {formData.email}. We look
      ...
      <section className="relative overflow-hidden pt-20 pb-16 md:pt-10 md:pb-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center space-y-6">
            ...
            {/* Headline */}
            <h1 className="luxury-text text-5xl md:text-6xl leading-tight text-white lg:text-6xl">
              Book Your
            ...
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed font-light">
              Select your preferred service, date, and time to book your beauty appointment.
            </p>
          </div>
        </div>
      </section>
