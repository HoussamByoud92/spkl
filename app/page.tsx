...
export default function Home() {
  ...
  const testimonials = [
    {
      text: "Sparkle Beauty Empire is where luxury meets artistry. Every detail is perfection.",
      author: "Sara M.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <Link
                  href="/booking"
                  className="group px-8 py-4 bg-[#ffe3a5] rounded-full font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105 inline-flex items-center justify-center gap-2 luxury-shadow text-card"
                >
            ...
            >
              ...
              <img
                ...
                alt="Luxury beauty services at Sparkle Beauty Empire"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative h-80 md:h-96 rounded-3xl overflow-hidden luxury-shadow-lg hidden md:block">
              <img
                src="/hero-beauty-salon.jpg"
                alt="Sparkle Beauty Empire salon"
            ...
            <ScrollAnimation className="space-y-6">
              <div>
                <p className="text-primary font-serif text-lg mb-3">About Sparkle Beauty Empire</p>
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-8 py-3 bg-[#ffe3a5] rounded-full font-semibold hover:shadow-lg transition-all hover:scale-105 group text-card"
              >
                Learn More
                <span className="group-hover:translate-x-1 transition-transform">→</span>
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation>
            <div className="text-center mb-20">
              ...
              <p className="text-lg max-w-2xl mx-auto leading-relaxed text-foreground">
                Discover the transformations and joy our clients experience at Sparkle Beauty Empire.
              </p>
            </div>
          </ScrollAnimation>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <ScrollAnimation>
            ...
            <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Step into a world of luxury and elegance. Book your appointment today and discover the Sparkle Beauty Empire
              difference.
            </p>
            <Link
              href="/booking"
              className="inline-flex items-center gap-2 px-10 py-4 bg-[#ffe3a5] text-black rounded-full font-semibold hover:shadow-2xl transition-all duration-300 hover:scale-105 bg-background"
            >
              Reserve Your Slot
              <span>→</span>
            </Link>
