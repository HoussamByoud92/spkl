...
export default function AboutPage() {
  ...
  const testimonials = [
    ...
    {
      text: "Professionalism and care define Sparkle Beauty Empire. My lashes and nails have never looked better, thanks to their skilled team.",
      author: "Leila K.",
      role: "Event Planner",
    },
    {
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center space-y-6">
            ...
            <p className="md:text-xl max-w-2xl mx-auto leading-relaxed text-primary-foreground font-semibold text-sm">
              At Sparkle Beauty Empire, we are dedicated to empowering confidence through beauty. Our mission is to
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground">
                At Sparkle Beauty Empire, we believe that beauty is more than just appearance—it&#39;s about feeling
      ...
      <section className="py-20 md:py-32 text-primary-foreground bg-accent">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="md:text-4xl font-bold mb-6 text-2xl">Ready to Experience Sparkle Beauty Empire?</h2>
          <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
            Book your appointment today and discover the Sparkle Beauty Empire difference.
          </p>
          <Link
            href="/booking"
            className="inline-flex items-center gap-2 px-8 py-3 bg-[#ffe3a5] text-black rounded-full font-semibold hover:bg-[#ddaa38] hover:shadow-lg transition-all hover:scale-105 bg-background"
          >
            Book Now
          </Link>
        </div>
